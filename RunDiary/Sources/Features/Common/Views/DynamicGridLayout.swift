...
struct DynamicGridLayout<Data: RandomAccessCollection, Content: View>: View
...
private struct GridContent<Data: RandomAccessCollection, Content: View>: View
where Data.Element: Hashable {
  let items: Data
  let content: (Data.Element) -> Content
  ...
  init(
    items: Data, content: @escaping (Data.Element) -> Content, geometry: GeometryProxy,
